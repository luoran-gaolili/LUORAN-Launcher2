...
import com.rgks.launcher3.BubbleTextView.BubbleTextShadowHandler;
import com.rgks.launcher3.FolderIcon.FolderRingAnimator;
import com.rgks.launcher3.accessibility.DragAndDropAccessibilityDelegate;
import com.rgks.launcher3.accessibility.WorkspaceAccessibilityHelper;
import com.rgks.launcher3.much.RgkConfig;
import com.rgks.launcher3.util.ParcelableSparseArray;
...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    public static int[] rectToCell(int width, int height, int[] result) {
        ...
        DeviceProfile grid = mLauncher.getDeviceProfile();
        InvariantDeviceProfile invariantDeviceProfile = app.getInvariantDeviceProfile();
        Rect padding = grid.getWorkspacePadding(true);

        // Always assume we're working with the smallest span to make sure we
        // reserve enough space in both orientations.
        int parentWidth = grid.calculateCellWidth(grid.widthPx
                - padding.left - padding.right, (int) invariantDeviceProfile.numColumns);
        int parentHeight = grid.calculateCellHeight(grid.heightPx
                - padding.top - padding.bottom, (int) invariantDeviceProfile.numRows);
