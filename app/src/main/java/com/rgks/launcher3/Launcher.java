...
import com.rgks.launcher3.DropTarget.DragObject;
import com.rgks.launcher3.PagedView.PageSwitchListener;
import com.rgks.launcher3.allapps.AllAppsContainerView;
import com.rgks.launcher3.allapps.DefaultAppSearchController;
import com.rgks.launcher3.compat.AppWidgetManagerCompat;
import com.rgks.launcher3.compat.LauncherActivityInfoCompat;
import com.rgks.launcher3.compat.LauncherAppsCompat;
import com.rgks.launcher3.compat.UserHandleCompat;
...
import com.rgks.launcher3.overview.ui.OverViewTabs;
import com.rgks.launcher3.util.ComponentKey;
import com.rgks.launcher3.util.LongArrayMap;
...
import com.rgks.launcher3.widget.WidgetHostViewLoader;
import com.rgks.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.kikikeji.weizhuo.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    static final String ACTION_FIRST_LOAD_COMPLETE =
            "com.kikikeji.weizhuo.action.FIRST_LOAD_COMPLETE";
    ...
    private void handleActivityResult(
        ...
        // Log.d("GLL666","RESULT_CANCELED");
        if (requestCode == REQUEST_BIND_APPWIDGET) {
            //  Log.d("GLL666","REQUEST_BIND_APPWIDGET");
        ...
        exitSpringLoadedDragModeDelayed((resultCode != RESULT_CANCELED), Launcher.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT,
                null);
...
//mWorkspace.showPageIndex(-1);
    ...
    private void setupOverviewPanel() {
        mOverviewPanel = (ViewGroup) findViewById(R.id.overview_tabs);
        ...
        //linearLayout = (LinearLayout) findViewById(R.id.nav_layout);
    ...
    private void addAppWidgetToWorkspace(LauncherAppWidgetInfo item,
                                         AppWidgetProviderInfo appWidgetInfo, boolean insert) {
    ...
    public void onWindowVisibilityChanged(int visibility) {
        ...
        if (mVisible) {
            if (!mWorkspaceLoading) {
                mAppsCustomizeTabHost.onWindowVisible();//add lallapp code by luoran 20170313
    ...
    AppWidgetHostView boundWidget, final AppWidgetProviderInfo appWidgetInfo) {
        if (LOGD) {
    ...
    protected void onClickWallpaperPicker(View v) {
        ...
        startActivityForResult(new Intent(Intent.ACTION_SET_WALLPAPER).setPackage(getPackageName())
                        .putExtra(com.rgks.launcher3.WallpaperPickerActivity.EXTRA_WALLPAPER_OFFSET, offset),
...
//Log.d("GLLLR","1");
    ...
    //add by luoran for modify workspace BSLLSL-1764(start)
    ...
    //add by luoran for modify workspace BSLLSL-1764(end)
    ...
    public void bindAppsUpdated(final ArrayList<AppInfo> apps) {
        ...
        mAppsCustomizeContent.updateApps(apps);//add lallapp code by luoran 20170313
    }
    ...
    public void bindWidgetsModel(WidgetsModel model) {
        ...
        if (mWidgetsView != null && model != null) {
            ...
            // mAppsCustomizeContent.onPackagesUpdated(model);//add lallapp code by luoran 20170313
            mWidgetsModel = null;
        }
    }
...
//add lallapp code by luoran 20170313 end
    ...
    interface DebugIntents {
        static final String DELETE_DATABASE = "com.kikikeji.weizhuo.action.DELETE_DATABASE";
        static final String MIGRATE_DATABASE = "com.kikikeji.weizhuo.action.MIGRATE_DATABASE";
    }
