...
import com.rgks.launcher3.Launcher.CustomContentCallbacks;
import com.rgks.launcher3.Launcher.LauncherOverlay;
import com.rgks.launcher3.LauncherSettings.Favorites;
import com.rgks.launcher3.UninstallDropTarget.UninstallSource;
import com.rgks.launcher3.accessibility.LauncherAccessibilityDelegate;
import com.rgks.launcher3.accessibility.LauncherAccessibilityDelegate.AccessibilityDragSource;
import com.rgks.launcher3.accessibility.OverviewScreenAccessibilityDelegate;
import com.rgks.launcher3.accessibility.WorkspaceAccessibilityHelper;
...
import com.rgks.launcher3.util.WallpaperUtils;
...
public class Workspace extends PagedView
        ...
        Insettable, UninstallSource, AccessibilityDragSource, Stats.LaunchSourceProvider, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final static long EXTRA_ADD_SCREEN_ID = -401; // add by luoran
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (RgkConfig.SCREEN_EFFECT_PREFS.equals(key)) {
            ...
            if (currentPage == 0) {
                ...
                snapToPage(currentPage - 1, EFFECT_TIME);
                new Handler().postDelayed(new Runnable() {
...
// in all apps or customize mode)
    ...
    public long addNewScreen() {
        ...
        newScreen.setOnClickListener(mLauncher);
        newScreen.setSoundEffectsEnabled(false);
        newScreen.setBackgroundResource(R.drawable.home_current);
        mWorkspaceScreens.put(newId, newScreen);
        mScreenOrder.add(insertIndex, newId);
        mLauncher.getModel().updateWorkspaceScreenOrder(mLauncher, mScreenOrder);
        addView(newScreen, insertIndex);
        Log.d("LUORAN456", "mNewBackgroundAlphas:");
        newScreen.setBackgroundAlpha(1.0f); //设置背景透明度
    ...
    public long addCreatorScreen() {
        ...
        // Log.d("LUORAN111","EXTRA_ADD_SCREEN_ID:"+EXTRA_ADD_SCREEN_ID);
    ...
    public void removeExtraEmptyScreen(final boolean animate, boolean stripEmptyScreens) {
        //Log.d("GLL666","removeExtraEmptyScreen");
    ...
    private void fadeAndRemoveEmptyScreen(int delay, int duration, final Runnable onComplete,
        ...
        // Log.d("FADE","fadeAndRemoveEmptyScreen");
    ...
    */
    ...
    void moveToDefaultScreen(boolean animate) {
        //获取默认桌面
        mDefaultPage = sharedPreferences.getInt("default_home_screen", 0);
