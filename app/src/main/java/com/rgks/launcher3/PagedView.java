...
import com.rgks.launcher3.util.LauncherEdgeEffect;
...
//add lallapp code by luoran 20170313 end
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (pageCount > 0) {
            ...
            if (screenCenter != mLastScreenCenter || mForceScreenScrolled) {
                ...
                //  Log.d("LUORAN666","mLastScreenCenter");
    ...
    protected void loadAssociatedPages(int page, boolean immediateAndOnly) {
        if (mContentIsRefreshable) {
            ...
            if (page < count) {
                ...
                //  Log.d("LR666", "mDirtyPageContent:" + mDirtyPageContent.size());
    ...
    protected void invalidatePageData(int currentPage, boolean immediateAndOnly) {
        ...
        if (mContentIsRefreshable) {
            ...
            Log.d("LR667", "mDirtyPageContent111:" + mDirtyPageContent.size());
            for (int i = 0; i < count; ++i) {
