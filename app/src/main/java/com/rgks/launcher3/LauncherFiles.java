...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.kikikeji.weizhuo.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.kikikeji.weizhuo.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.kikikeji.weizhuo.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.kikikeji.weizhuo.compat.PackageInstallerCompatV16.queue"));
}
