...
public class TestingUtils {
    ...
    public static final String MEMORY_TRACKER = "com.kikikeji.weizhuo.testing.MemoryTracker";
    public static final String ACTION_START_TRACKING = "com.kikikeji.weizhuo.action.START_TRACKING";
    ...
    public static final String DUMMY_WIDGET = "com.kikikeji.weizhuo.testing.DummyWidget";
