...
public class RgkWidgetPreviewLoader {
    ...
    public RgkWidgetPreviewLoader(Context context) {
        LauncherAppState app = LauncherAppState.getInstance();
        InvariantDeviceProfile grid = app.getInvariantDeviceProfile();

        mContext = context;
        //修改小部件(快捷方式)的大小预览图
        mAppIconSize = (int) grid.iconSize + 30;
    ...
    public Bitmap generatePreview(Object info, Bitmap preview) {
        ...
        if (info instanceof AppWidgetProviderInfo) {
            ...
            //  Log.d("LR4567", "generateShortcutPreview:" + (ResolveInfo) info);
