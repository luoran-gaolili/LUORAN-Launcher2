...
public class WallpaperLayout extends LinearLayout implements InitPage {
    ...
    private static volatile WallpaperLayout wallpaperLayoutSingleInstance = null;

    private WallpaperLayout(Context context) {
        super(context);

    }

    //单例模式获取实例
    public static WallpaperLayout getUnderLinesSingleInstance(Context context) {
        if (wallpaperLayoutSingleInstance == null) {
            synchronized (UnderlinesNoFadeLayout.class) {
                if (wallpaperLayoutSingleInstance == null) {
                    wallpaperLayoutSingleInstance = new WallpaperLayout(context);
                }
            }
        }
        return wallpaperLayoutSingleInstance;
    }

    public void setmAnimController(LayoutAnimationController animController) {
