 ...
 */
public class RgkPagedViewWidget extends LinearLayout {
    ...
    static RgkPagedViewWidget sShortpressTarget = null;
    boolean mIsAppWidget;
    private final Rect mOriginalImagePadding = new Rect();
    private Object mInfo;
    private RgkWidgetPreviewLoader mWidgetPreviewLoader;

    public RgkPagedViewWidget(Context context) {
        this(context, null);
    }

    public RgkPagedViewWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RgkPagedViewWidget(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
      ...
      /*  TextView name = (TextView) findViewById(R.id.widget_name);
        if (name != null) {
            name.setTextSize(TypedValue.COMPLEX_UNIT_PX, grid.iconTextSize);
        }
        TextView dims = (TextView) findViewById(R.id.widget_dims);
        if (dims != null) {
            dims.setTextSize(TypedValue.COMPLEX_UNIT_PX, grid.iconTextSize);
        }*/
    }
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
                                               int maxWidth, int[] cellSpan, RgkWidgetPreviewLoader loader) {
        LauncherAppState app = LauncherAppState.getInstance();
        InvariantDeviceProfile grid = app.getInvariantDeviceProfile();
    ...
    public void applyFromResolveInfo(
            PackageManager pm, ResolveInfo info, RgkWidgetPreviewLoader loader) {
        mIsAppWidget = false;
        mInfo = info;
    ...
    class CheckForShortPress implements Runnable {
        public void run() {
            ...
            if (mShortPressListener != null) {
                mShortPressListener.onShortPress(RgkPagedViewWidget.this);
                sShortpressTarget = RgkPagedViewWidget.this;
            }
    ...
    private void cleanUpShortPress() {
        ...
        if (mShortPressTriggered) {
            if (mShortPressListener != null) {
                mShortPressListener.cleanUpShortPress(RgkPagedViewWidget.this);
            }
