...
class RgkPendingAddWidgetInfo extends PendingAddItemInfo {
    int minWidth;
    int minHeight;
    int minResizeWidth;
    int minResizeHeight;
    ...
    public RgkPendingAddWidgetInfo(AppWidgetProviderInfo i, String dataMimeType, Parcelable data) {
    ...
    // Copy constructor
    public RgkPendingAddWidgetInfo(RgkPendingAddWidgetInfo copy) {
