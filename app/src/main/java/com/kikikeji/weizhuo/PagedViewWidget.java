...
public class PagedViewWidget extends LinearLayout {
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
        ...
        name.setText(AppWidgetManagerCompat.getInstance(getContext()).loadLabel((LauncherAppWidgetProviderInfo) info));
        final TextView dims = (TextView) findViewById(R.id.widget_dims);
        if (dims != null) {
            int hSpan = Math.min(cellSpan[0], (int) 2);
            int vSpan = Math.min(cellSpan[1], (int) 3);
