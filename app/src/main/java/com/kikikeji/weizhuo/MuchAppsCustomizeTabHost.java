...
import com.kikikeji.weizhuo.overview.ui.InitPage;
 ...
 */
public class MuchAppsCustomizeTabHost extends FrameLayout implements LauncherTransitionable, Insettable ,InitPage {
    static final String LOG_TAG = "AppsCustomizeTabHost";

    private static final String APPS_TAB_TAG = "APPS";
    private static final String WIDGETS_TAB_TAG = "WIDGETS";

    private MuchAppsCustomizePagedView mPagedView;//这个是app、widget的那个容器
    ...
    protected void onFinishInflate() {
        mPagedView = (MuchAppsCustomizePagedView) findViewById(R.id.apps_customize_pane_content);
