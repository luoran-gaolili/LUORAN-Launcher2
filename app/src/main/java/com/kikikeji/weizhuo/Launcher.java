...
import com.kikikeji.weizhuo.PagedView.PageSwitchListener;
import com.kikikeji.weizhuo.allapps.AllAppsContainerView;
import com.kikikeji.weizhuo.allapps.DefaultAppSearchController;
...
import com.kikikeji.weizhuo.widget.WidgetHostViewLoader;
...
//mWorkspace.showPageIndex(-1);
    ...
    protected void onClickWallpaperPicker(View v) {
        ...
        startActivityForResult(new Intent(Intent.ACTION_SET_WALLPAPER).setPackage(getPackageName())
                        .putExtra(com.kikikeji.weizhuo.WallpaperPickerActivity.EXTRA_WALLPAPER_OFFSET, offset),
